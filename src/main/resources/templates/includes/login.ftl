        ...
        <div class="col-md-6 offset-md-3">
            ...
            <div class="card my-5">
                ...
                <form id="loginForm" class="card-body cardbody-color p-lg-5">
                    ...
                    <div class="mb-3">
                        <input  name="userEmail" type="text" class="form-control" id="Username" aria-describedby="emailHelp" placeholder="User Name / Email">
                    </div>
                    <div class="mb-3">
                    ...
                    <div id="emailHelp" class="form-text mb-3 text-dark">
                        <div class="mb-2" >Not Registered? <a href="/registration.html" class="text-dark fw-bold"> Create an Account</a></div>
